...
(function() {
  ...
  Org = (function() {
    ...
    Org.prototype.hooks = function(cb) {
      return this.client.get("/orgs/" + this.name + "/hooks", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Org.prototype.hook = function(hookInfo, cb) {
      return this.client.post("/orgs/" + this.name + "/hooks", hookInfo, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
