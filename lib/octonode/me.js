...
(function() {
  ...
  Me = (function() {
    ...
    _hasRepoName = function(repoName, repos) {
      return repos.some(function(element, index, array) {
        return element.name.toLowerCase() === repoName || element.full_name.toLowerCase() === repoName;
      });
    };
    ...
    Me.prototype.getWatchedRepositories = function(cb) {
      return this.client.get("/user/subscriptions", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
          return cb(new Error('User subscriptions error'));
        } else {
          return cb(null, b, h);
        }
      });
    ...
    Me.prototype.isWatching = function(repo, cb) {
      return this.client.get("/user/subscriptions", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
    ...
    Me.prototype.startWatching = function(cb) {
      var options;
      options = {
        subscribed: true,
        ignored: false
    ...
    Me.prototype.stopWatching = function(cb) {
