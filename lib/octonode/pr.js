...
(function() {
  ...
  Pr = (function() {
    ...
    Pr.prototype.removeComment = function(comment, cb) {
      return this.client.post("/repos/" + this.repo + "/pulls/" + this.number + "/comments/" + this.comment, comment, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
