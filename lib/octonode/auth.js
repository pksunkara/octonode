  ...
  auth = module.exports = {
    ...
    login: function(scopes, callback) {
      ...
      if (this.mode === this.modes.cli) {
        ...
        return request(options, function(err, res, body) {
          if (err != null) {
            return callback(err, null, null, res != null ? res.headers : void 0);
          } else {
            try {
            ...
            if (res.statusCode === 201) {
              return callback(null, body.id, body.token, res != null ? res.headers : void 0);
            } else {
              return callback(new Error(body.message), null, null, res != null ? res.headers : void 0);
            }
          }
        });
        ...
        if (scopes instanceof Array) {
          ...
          return request({
            ...
            if (err != null) {
              return callback(err, null, res != null ? res.headers : void 0);
            } else if (res.statusCode === 404) {
              return callback(new Error('Access token not found'));
            } else {
              body = qs.parse(body);
              if (body.error) {
                return callback(new Error(body.error), null, res != null ? res.headers : void 0);
              } else {
                return callback(null, body.access_token, res != null ? res.headers : void 0);
              }
            }
          });
        }
