...
(function() {
  ...
  Team = (function(superClass) {
    ...
    Team.prototype.addRepo = function(repo, cbOrOptions, cb) {
      var param;
      if ((cb == null) && cbOrOptions) {
        cb = cbOrOptions;
        param = {};
      ...
      return this.client.put("/teams/" + this.id + "/repos/" + repo, param, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
          return cb(new Error("Team addRepo error"));
        } else {
          return cb(null, b, h);
        }
      });
