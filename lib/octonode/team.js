...
(function() {
  ...
  Team = (function() {
    ...
    Team.prototype.newUser = function(user, cb) {
      return this.client.put("/teams/{@id}/members/" + user, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        return cb(null, s === 204, h);
    ...
    Team.prototype.rmUser = function(user, cb) {
      return this.client.del("/teams/" + this.id + "/members/" + user, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        return cb(null, s === 204, h);
