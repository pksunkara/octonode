...
(function() {
  ...
  Repo = (function() {
    ...
    Repo.prototype.create_commit = function(message, tree_sha, parents, cb) {
      var input;
      input = {
        message: message,
        parents: parents,
      ...
      return this.client.post("/repos/" + this.name + "/git/commits", input, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
          return cb(new Error("Repo create_commit error"));
        } else {
          return cb(null, b);
        }
      });
    ...
    Repo.prototype.blob = function(sha, cb) {
      return this.client.get("/repos/" + this.name + "/git/blobs/" + sha, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Repo.prototype.create_blob = function(content, encoding, cb) {
      var input;
      input = {
        content: content,
        encoding: encoding
      };
      return this.client.post("/repos/" + this.name + "/git/blobs", input, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
          return cb(new Error("Repo create_blob"));
        } else {
          return cb(null, b);
        }
      });
    ...
    Repo.prototype.tree = function(sha, cb) {
      return this.client.get("/repos/" + this.name + "/git/trees/" + sha, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Repo.prototype.create_tree = function(tree, cb) {
      return this.client.post("/repos/" + this.name + "/git/trees", tree, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
          return cb(new Error("Repo create_tree error"));
        } else {
          return cb(null, b);
        }
      });
    ...
    Repo.prototype.update_reference = function(ref, sha, force, cb) {
      var input;
      if (!cb) {
        cb = force;
        force = false;
      ...
      return this.client.patch("/repos/" + this.name + "/git/refs/" + ref, input, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
          return cb(new Error("Repo update_ref error"));
        } else {
          return cb(null, b);
        }
      });
