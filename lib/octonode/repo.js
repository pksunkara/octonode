...
(function() {
  ...
  Repo = (function(superClass) {
    ...
    Repo.prototype.deleteRelease = function(releaseId, cb) {
      return this.client.delete("/repos/" + this.name + "/releases/" + releaseId, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
          return cb(new Error("Repo deleteRelease error"));
        } else {
          return cb(null, b, h);
        }
      });
