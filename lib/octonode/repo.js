...
(function() {
  ...
  Repo = (function(superClass) {
    ...
    Repo.prototype.getBranches = function(ref, sha, cb) {
      return this.client.get("/repos/" + this.name + "/branches/" + ref, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
          return cb(new Error("Repo getBranches error"));
        } else {
          return cb(null, b, h);
        }
      });
