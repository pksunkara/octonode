...
(function() {
  ...
  Repo = (function() {
    ...
    Repo.prototype.collaborators = function(cb) {
    ...
    Repo.prototype.hasCollaborator = function(collabUser, cb) {
      return this.client.get("repos/" + this.name + "/collaborators/" + collabUser, function(err, s, b) {
        if (err) {
          return cb(err);
        }
        if (s !== 204 && s !== 404) {
