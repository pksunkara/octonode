...
(function() {
  ...
  Repo = (function() {
    ...
    Repo.prototype.release = function(numberOrCb, cb) {
      if (typeof cb === 'function' && typeof numberOrCb === 'object') {
        return this.createRelease(numberOrCb, cb);
      } else {
        return this.client.release(this.name, numberOrCb);
      }
    };

    Repo.prototype.createRelease = function(tag, cbOrOptions, cb) {
      var param;
      if ((cb == null) && cbOrOptions) {
        cb = cbOrOptions;
        cbOrOptions = null;
      ...
      return this.client.post("/repos/" + this.name + "/releases", param, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
