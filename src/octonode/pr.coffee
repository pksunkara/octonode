...
class Pr
  ...
  info: (cb) ->
    @client.get "/repos/#{@repo}/pulls/#{@number}", null, (err, s, b) ->
  ...
  update: (obj, cb) ->
    @client.post "/repos/#{@repo}/pulls/#{@number}", null, obj, (err, s, b) ->
      return cb(err) if err
  ...
  merged: (cb) ->
    @client.get "/repos/#{@repo}/pulls/#{@number}/merge", null, (err, s, b) ->
  ...
  merge: (msg, cb) ->
    @client.put "/repos/#{@repo}/pulls/#{@number}/merge", null,
      commit_message: msg
    , (err, s, b) ->
      return cb(err) if err
      cb null, b
  ...
  commits: (cb) ->
    @client.get "/repos/#{@repo}/pulls/#{@number}/commits", null, (err, s, b) ->
      return cb(err) if err
  ...
  files: (cb) ->
    @client.get "/repos/#{@repo}/pulls/#{@number}/files", null, (err, s, b) ->
      return cb(err) if err
