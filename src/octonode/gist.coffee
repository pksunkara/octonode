...
class Gist
  ...
  # '/gists/public' GET
  public: (cb) ->
    @client.get "/gists/public", null, (err, s, b) ->
      return cb(err) if err
  ...
  # '/gists/starred' GET
  starred: (cb) ->
    @client.get "/gists/starred", null, (err, s, b) ->
      return cb(err) if err
  ...
  user: (user, cb) ->
    @client.get "/users/#{user}/gists", null, (err, s, b) ->
      return cb(err) if err
  ...
  # '/gists/37' GET
  get: (id, cb) ->
    @client.get "/gists/#{id}", null, (err, s, b) ->
      return cb(err) if err
  ...
  # '/gists' POST
  create: (gist, cb) ->
    @client.post "/gists", null, gist, (err, s, b) ->
      return cb(err) if err
  ...
  # '/gists/37' PATCH
  edit: (id, gist, cb) ->
    @client.post "/gists/#{id}", null, gist, (err, s, b) ->
      return cb(err) if err
  ...
  # '/gists/37' DELETE
  delete: (id) ->
    @client.del "/gists/#{id}", null, {}, (err, s, b) =>
      @delete(id) if err? or s isnt 204

  # Star a gist
  # '/gists/37/star' PUT
  star: (id) ->
    @client.put "/gists/#{id}/star", null, {}, (err, s, b) =>
      @star(id) if err? or s isnt 204

  # Unstar a gist
  # '/gists/37/unstar' DELETE
  unstar: (id) ->
    @client.del "/gists/#{id}/unstar", null, {}, (err, s, b) =>
      @unstar(id) if err? or s isnt 204

  # Check if a gist is starred
  # '/gists/37/star' GET
  check: (id) ->
    @client.get "/gists/#{id}/star", null, (err, s, b) ->
      return cb(err) if err
      cb null, s is 204
  ...
  listComments: (id, cb) ->
    @client.get "/gists/#{id}/comments", null, (err, s, b) ->
      return cb(err) if err
  ...
  getComment: (id, cb) ->
    @client.get "/gists/comments/#{id}", null, (err, s, b) ->
      return cb(err) if err
  ...
  createComment: (id, comment, cb) ->
    @client.post "/gists/#{id}/comments", null, comment, (err, s, b) ->
      return cb(err) if err
  ...
  updateComment: (id, comment, cb) ->
    @client.post "/gists/comments/#{id}", null, comment, (err, s, b) ->
      return cb(err) if err
  ...
  deleteComment: (id) ->
    @client.del "/gists/comments/#{id}", null, {}, (err, s, b) =>
